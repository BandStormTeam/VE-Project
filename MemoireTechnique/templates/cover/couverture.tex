...
\begin{tabular}{p{8cm}p{5cm}p{6cm}}
	\begin{minipage}{8cm}
		\includegraphics[width=4cm]{screens/m2dl.png}\\
		\tiny{Master 2 Développement Logiciel}
		\small
...
\vspace{-40px}
 \includegraphics[width=8cm]{images/PACA.jpg}
\vspace{70px}
...
\begin{itemize}
			\item Julian \bsc{Bironneau}
			\item Antoine de \bsc{Roquemaurel}
			\item Steve \bsc{Magras}
			\item Dylan \bsc{Roletto}
			\item Zaccaria \bsc{Zyat}
\end{itemize}
\end{minipage}
